#!/usr/bin/env python3
"""
validate_risk.py - Episode clustering to get 4-6 fires + 3x-calibrated Chandelier
...
if __name__ == "__main__":
    ...
    print("\n=== BREAKER: EPISODE CLUSTERING ===")
    print("Cluster sub-dips into episodes, must recover to -3% + 20 days to start new episode")
    ...
    print(f"  With breaker MaxDD: {(eq_breaker/eq_breaker.cummax()-1).min()*100:.1f}%")
    ...
    print("\n=== CHANDELIER: 3x-CALIBRATED (1.5-2.5x) + EXIT REASON LOGGING ===")
    qqq_close = close["QQQ"]
    ...
    for ticker in ["SOXL","QLD","TQQQ"]:
        ...
        try:
            ...
            print(f"    -> For 3x ETFs, 1.5-2.5x should give 40-60% ATR exits, not 0%. 3.5x should be mostly trend exits.")
